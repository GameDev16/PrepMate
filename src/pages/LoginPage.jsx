    ...
    <div className="min-h-screen bg-chalk flex items-center justify-center p-4 relative font-body text-ink selection:bg-frost">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-normal text-[42px] text-ink tracking-tight leading-tight">Welcome back</h1>
          <p className="text-lg text-ink/70 mt-1 font-normal">Sign in to continue your creative studies</p>
        </div>
        ...
        <div className="bg-paper border border-frost rounded-[24px] p-8 shadow-hard">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-normal text-ink mb-2">Password</label>
              <input
                type="password"
                value={password}
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-sm font-normal text-electric-iris hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-frost"></div>
            </div>
            <div className="relative flex justify-center">
              <span className="bg-paper px-4 text-xs font-mono uppercase tracking-wider text-ink/50">or</span>
            </div>
          </div>

          <button
            onClick={handleGoogleLogin}
            className="w-full py-3 bg-transparent border border-ink text-ink font-normal rounded-full hover:bg-frost transition-all flex items-center justify-center gap-3"
          >
          ...
          <p className="text-center text-sm text-ink/70 mt-6 font-normal">
            ...
            <Link to="/register" className="text-electric-iris font-normal hover:underline">
              Sign up
            </Link>
          </p>
        </div>
