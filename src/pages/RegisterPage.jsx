    ...
    <div className="min-h-screen bg-chalk flex items-center justify-center p-4 relative font-body text-ink selection:bg-frost">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-normal text-[42px] text-ink tracking-tight leading-tight">Create account</h1>
          <p className="text-lg text-ink/70 mt-1 font-normal">Start turning chapters into art room notes today</p>
        </div>
        ...
        <div className="bg-paper border border-frost rounded-[24px] p-8 shadow-hard">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-normal text-ink mb-2">Full name</label>
              <input
                type="text"
                value={name}
